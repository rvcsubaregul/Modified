        ...
        with gr.Tab("Generate"):
            ...
            with gr.Accordion('Main Options'):
                with gr.Row():
                    ...
                    with gr.Column():
                        pitch = gr.Slider(-12, 12, value=0, step=0.1, label='Pitch Change (Semitones)', info='Fine pitch control in semitones. Use small values like ±0.5 or ±1 for natural vocals.')
